...
EntityGenerator.prototype.files = function files() {
  ...
  this.template('../../app/templates/src/main/resources/_hibernate-local.cfg.xml', resourceDir + 'hibernate-local.cfg.xml');
  this.template('src/main/java/package/models/_Entity.java', modelsDir + _s.capitalize(this.name) + '.java');
  _.each(this.attrs, function (attr) {
    if (attr.attrType === 'Enum') {
      this.attr = attr;
      this.template('src/main/java/package/models/_AttrEnum.java', modelsDir + _s.capitalize(attr.attrName) + 'Enum.java');
    }
  }.bind(this));
